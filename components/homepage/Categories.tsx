...
import { Avatar, Card, Container, Link, Text } from "@nextui-org/react";
import categoriesData from './Categories.json'
function Categories() {
  const categories = categoriesData.categories;

  return (   
    <div style={{ backgroundColor: "whitesmoke", marginLeft: '0', padding: '0', height: "350px" }} >
      ...
      <div className="scrolling-wrapper" style={{}}>
        ...
        <div className="card" key={category.name}>
          <Link href="/" css={{ display: 'block', marginLeft: '$8', marginRight: "$8" }}>
            <Avatar
